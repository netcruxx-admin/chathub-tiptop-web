						...
						<div className='bg-card rounded-xl p-6 shadow-sm border'>
							...
							<div className='flex items-center space-x-4 text-sm text-muted-foreground'>
								<div className='flex items-center space-x-1'>
									...
									<span className='capitalize'>{selectedJob.paymentType}</span>
								</div>
								<div className='flex items-center space-x-1'>
							...
							<div className='bg-card rounded-xl p-6 shadow-sm border space-y-4'>
								...
								<div className='space-y-3'>
									...
									<div className='space-y-1 text-sm text-muted-foreground'>
										<p>
											<strong>Provider:</strong> {selectedJob.training.provider}
										</p>
										<p>
											<strong>Duration:</strong> {selectedJob.training.duration}
										</p>
										<p>
											<strong>Mode:</strong>{' '}
											{selectedJob.training.mode === 'learn-first'
												? 'Complete training before job'
												: selectedJob.training.mode === 'learn-on-job'
													? 'Learn while working'
